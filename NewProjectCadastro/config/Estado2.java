...
public class Estado2 {
	...
	public static final List<Interesses2> INTERESSES;
	static{

		ESTADOS= new ArrayList<>(); // Permite criar listas. e mantem os dados inseridos ordanados para acessá-los através de índices.	
		...
		ESTADOS.add(new Estado("Espiríto Santo " ,"ES"));
